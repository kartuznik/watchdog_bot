...
3. **🔗 Источники** — нумерованные названия (опционально короткий домен в скобках); без «голых» и percent-encoded URL в тексте; URL только на **inline-кнопках**; превью ссылок / карточки Instant View отключены.
