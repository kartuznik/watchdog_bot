...
3. **🔗 Источники** — нумерованные **кликабельные названия** как HTML-якоря `<a href="полный_url_статьи">`; плюс **inline-кнопки** с теми же URL. Голых доменов в скобках нет (они автолинковались на главную сайта). Превью ссылок / Instant View отключены.
